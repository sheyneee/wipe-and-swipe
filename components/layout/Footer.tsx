        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-sm leading-relaxed">
              Professional cleaning services that transform your space. Eco-friendly, reliable, and always sparkling clean.
            </p>
          </div>
          ...
          <div> 
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link href="/#services" className="hover:text-teal-400 transition-colors">Commercial</Link></li>
              <li><Link href="/#services" className="hover:text-teal-400 transition-colors">Deep Cleaning</Link></li>
              <li><Link href="/book-now" className="hover:text-teal-400 transition-colors">Book Now</Link></li>
            </ul>
          </div>
        </div>
